...
abstract class UserProfileRepository {
  ...
  Future<Either<Failure, List<FollowEntity>>> getFollower(int userId);
  Future<Either<Failure, List<FollowEntity>>> getFollowing(int userId);
  Future<Either<Failure, UserProfileEntity>> editUserProfile(
      EditUserProfileReq userId);
  Future<Either<Failure, UserProfileEntity>> updateAvatar(
      File avatar);
