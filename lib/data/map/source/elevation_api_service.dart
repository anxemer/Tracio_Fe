...
abstract class ElevationApiService {
  Future<Either<String, List<ElevationPoint>>> postElevationFromPolyline(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['results'] != null) {
          ...
          return left('No results found');
        }
      } else {
        return left('Error fetching elevation data: ${response.statusCode}');
      }
    } catch (e) {
      return left('Error fetching elevation data: $e');
    }
