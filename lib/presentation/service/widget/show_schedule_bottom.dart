    ...
    return Column(
      children: [
        BasicTextButton(
          ...
          // (bookingCubit.reschedule.isNotEmpty)
          //     ? 'Reschedule ${bookingCubit.reschedule.length} ${bookingCubit.reschedule.length > 1 ? "services" : "service"}'
          //     : widget.service == null
          //         ? 'Book ${bookingCubit.selectedServices.length} ${bookingCubit.selectedServices.length > 1 ? "services" : "service"}'
          //         : 'Book service',
          onPress: () {
            // if ((bookingCubit.selectedServices.isEmpty) &&
            //     widget.service == null &&
            //     bookingCubit.reschedule.isEmpty) {
        ...
        builder: (context, setModalState) {
          return Column(
            children: [
              ...
              Expanded(child: scheduleList(context))
            ],
          );
        },
      ),
