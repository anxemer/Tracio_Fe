...
class RoutePlanDetailScreen extends StatefulWidget {
  final int routeId;
  const RoutePlanDetailScreen({super.key, required this.routeId});

  @override
  State<RoutePlanDetailScreen> createState() => _RoutePlanDetailScreenState();
}

class _RoutePlanDetailScreenState extends State<RoutePlanDetailScreen>
    with RouteAware {
